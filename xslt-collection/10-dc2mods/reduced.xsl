...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:sru_dc="info:srw/schema/1/dc-schema" xmlns:oai_dc="http://www.openarchives.org/OAI/2.0/oai_dc/" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="sru_dc oai_dc dc" version="1.0"> <!-- removed xmlns="http://www.loc.gov/mods/v3" -->
    ...
    <xsl:template match="sru_dc--dcCollection">
        <modsCollection xmlns--xsi="http://www.w3.org/2001/XMLSchema-instance" xsi--schemaLocation="http://www.loc.gov/mods/v3 http://www.loc.gov/standards/mods/v3/mods-3-2.xsd"> <!-- removed xmlns="http://www.loc.gov/mods/v3" -->
			<xsl:apply-templates select="sru_dc--dc">
    ...
    <xsl:template match="sru_dc--dc">
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<mods version="3.2" xmlns--xsi="http://www.w3.org/2001/XMLSchema-instance" xsi--schemaLocation="http://www.loc.gov/mods/v3 http://www.loc.gov/standards/mods/v3/mods-3-2.xsd">
					<xsl:call-template name="dcMain"/>
				</mods>
			</xsl:otherwise>
		</xsl:choose>
	...
	<xsl:choose>
            <xsl:when test="string(text()) = 'Dataset' or string(text()) = 'dataset'">
                <typeOfResource>
			<xsl:if test="../dc--type"> <!-- removed predicate [string(text()) = 'collection' or string(text()) = 'Collection'] -->
