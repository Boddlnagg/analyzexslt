...
elements, change the sequence of the apply-templates statements.-->
		...
		<xsl:for-each select="row">
			<w--p>
				...
				<w--r>
					...
					<w--t>
						<xsl:value-of select="entry"/> <!-- removed predicate [1] -->
					</w--t>
					<w--tab/>
					<w--t>
						<xsl:value-of select="entry"/> <!-- removed predicate [2] -->
					</w--t>
					<w--tab/>
					<w--t>
						<xsl:value-of select="entry"/> <!-- removed predicate [3] -->
					</w--t>
				</w--r>
			</w--p>
		</xsl:for-each>
	...
	<xsl:template match="c02/did">
		<w--p>
			...
			<w--r>
				<w--t>
					<xsl:apply-templates select="container"/> <!-- removed predicate [1] -->
				</w--t>
				<w--tab/>
				<w--t>
					<xsl:apply-templates select="container"/> <!-- removed predicate [2] -->
				</w--t>
				<w--tab/>
				<w--t>
					<xsl:if test="unitid">
